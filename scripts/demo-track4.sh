...
echo ""
echo "  2. AGENTGATEWAY — ingress and LLM egress (Solo Enterprise UI)"
...
echo ""
echo "  3. KAGENT — agents, tools, traces (Solo Enterprise UI)"
echo "     - Solo Enterprise UI → Agents section"
